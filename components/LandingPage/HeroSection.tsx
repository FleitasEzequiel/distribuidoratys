...
const HeroSection = () => (
    <section className="relative overflow-hidden min-h-[500px] flex items-center justify-center bg-slate-100">
        <div className="absolute inset-0 z-0">
            <Image
                fill
                alt="Minimalist arrangement of products"
                className="w-full h-full object-top"
                src="/tys/carrousel1.png"
            />
            <div className="absolute inset-0 bg-white/70"></div>
        </div>
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
            <div className="inline-flex items-center rounded-full border border-slate-900/10 bg-white/50 px-3 py-1 text-sm font-medium text-slate-800 mb-6 backdrop-blur-sm">
                <span className="flex h-2 w-2 rounded-full bg-primary mr-2"></span>
                Nueva Colección Seleccionada
            </div>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-slate-900 mb-6 font-serif">
